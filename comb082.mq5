//+------------------------------------------------------------------+
//| comb082.mq5                                                      |
//| Strategy Combiner snapshot v082 — chart source for EA v2         |
//| Same logic as StrategyCombiner_v1; separate version for git.     |
//+------------------------------------------------------------------+
#property strict
...
input bool           UseIndicator2         = false; // پیش‌فرض خاموش تا تستر/چارت بدون فایل دوم بالا بیاید
